...
Usage:
    ...
    Then run from project root:
        python scripts/test_approve_recommendation.py [recommendation_id] [operator_id]
"""
...
try:
    ...
    print("  python scripts/test_approve_recommendation.py")
    sys.exit(1)
...
def main():
    ...
    if len(sys.argv) > 2:
        ...
        print("   Usage: python scripts/test_approve_recommendation.py <recommendation_id> <operator_id>")
